...
export function MenuPage({ hideHeader = false, initialCardId }: { hideHeader?: boolean; initialCardId?: string | null }) {
  ...
  useEffect(() => {
    if (initialCardId && MENU_CARDS[initialCardId as keyof typeof MENU_CARDS]) {
